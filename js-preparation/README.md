...
15. ### What is the currying function
    ...
    OR
Currying is the process in functional program, we transform a function with multiple arguments in to sequence of nested function that takes one argument at a time.
